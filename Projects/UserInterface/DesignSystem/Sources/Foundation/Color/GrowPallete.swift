...
public class GrowPallete {
    ...
    public let Neutral60 = Color(0xFF72727E)
    ...
    public let Primary10 = Color(0xFFE5FFF0)
    public let Primary20 = Color(0xFFCCFFE0)
    public let Primary30 = Color(0xFFB2FFD1)
    public let Primary40 = Color(0xFF80FFB2)
    public let Primary50 = Color(0xFF66FFA3)
    public let Primary60 = Color(0xFF33FF85)
    public let Primary70 = Color(0xFF00FF66)
    public let Primary80 = Color(0xFF00CC52)
    public let Primary90 = Color(0xFF00993D)
    public let Primary100 = Color(0xFF006629)
